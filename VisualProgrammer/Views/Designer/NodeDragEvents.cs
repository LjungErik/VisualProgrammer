...
namespace VisualProgrammer.Views.Designer
{
    ...
    */
    ...
    /// <summary>
    /// Arguments for event raised when the user starts to drag a node in the Designer.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for event raised while user is dragging a node in the Designer.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for event raised when the user has completed dragging a node in the Designer.
    /// </summary>
